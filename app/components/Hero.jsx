            ...
            <div className="relative z-10 max-w-[1200px] mx-auto px-6 w-full">
                ...
                <div className="grid md:grid-cols-2 gap-10 items-center mb-12">
                    ...
                    <div>
                        ...
                        {/* Subheadline */}
                        <p
                            className="text-base md:text-lg text-[var(--color-text-secondary)] max-w-[550px] leading-relaxed mb-8 animate-[fadeInUp_1s_ease-out]"
                            dangerouslySetInnerHTML={{ __html: hero.subheadline }}
                        />

                        {/* CTAs — left-aligned */}
                        <div className="flex flex-col sm:flex-row items-start gap-4 animate-[fadeInUp_1.1s_ease-out]">
                            {hero.ctas.map((cta, i) => (
                                <a
                                    key={i}
                    ...
                    {/* RIGHT: VSL Video */}
                    {hero.vslUrl && (
                        <div className="relative rounded-xl overflow-hidden animate-[fadeInUp_1.05s_ease-out] border border-[var(--color-accent)]/20">
                ...
                {hero.stats && (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-[900px] mx-auto animate-[fadeInUp_1.3s_ease-out] border-t border-[var(--color-border-default)] pt-8">
